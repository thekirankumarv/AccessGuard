...
<body class="animsition">
    ...
    <img src="images/apartment.jpg" alt="apartment image" class="apartment__img">
        <div class="page-content--bge5">
            <div class="container">
                <div class="login-wrap">
                    <div class="login-content">
                        <div class="login-logo">
                           <a class= "topic" href="index.php" style="font-size:24px;">
  ...
  <h5 class= "rec" align="center"> Password Recovery</h5>
  <hr>
